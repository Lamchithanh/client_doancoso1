        ...
        <div className="bg-orderpay">
                        ...
                        <div className="orderpay-product">
                                    ...
                                    <div className="orderpay-product-item">
                                        ...
                                        <div className="orderpay-item-name">
                                            <div className="item-name">
                                                <b>
                                                    Horbaach Maca 4800mg 120
                                                    Viên - Viên Uống Tăng Cường
                                                    Sinh Lý Nam Và Nữ (08/2025
                                                    Giao Nhanh 48H)
                                                </b>
                                            </div>
                            ...
                            <div className="thong-tin-dat-hang-da-co">
                                ...
                                <div className="ten-user-va-dia-chi">
                                    ...
                                    <div>
                                        <strong> 0981911449</strong> -
                                        pconeapk@gmail.com - ấp mỹ lộc ⏤ Xã Mỹ
                            ...
                            <div className="info-orderpay">
                                <div className="info-orderpay-login">
                                    <div className="info-orderpay-login-text">
                                        Đăng nhập tài khoản T&T để mua hàng, Quý
                                        Khách sẽ nhận thêm nhiều ưu đãi thành
                                        viên và nhận Loyalty Points trên mỗi đơn
                                        hàng.
                                    </div>
                                ...
                                <div className="write-info-orderpay">
                                    ...
                                    <div className="write-info-orderpay-text">
                                        Thông tin đặt hàng cũng sẽ được dùng để
                                        tạo tài khoản mới ngay sau khi đặt hàng
                                        thành công.
                                    </div>
                                    <Example />
                                </div>
                            ...
                            <div className="phuong-thuc-thanh-toan">
                                <div className="thong-tin-them">
                                    Giá sản phẩm đảm bảo không biến động trong
                                    vòng 60 phút căn cứ vào thời điểm Quý Khách
                                    Xác nhận đặt hàng thành công. Đơn hàng của
                                    Quý Khách chỉ được người bán thực hiện khi
                                    T&T xác nhận đơn hàng được đã được thanh
                                    toán.
                                </div>
                                <div className="chon-loai-thanh-toan">
                                    ...
                                    <div className="bank-khac">
                                        <div className="ma-khuyen-mai-mk23">
                                            <div className="mk23">
                                                Giảm 23,000đ cho đơn hàng từ 1.5
                                                triệu khi nhập mã KM23
                                            </div>
                                            <div className="info-orderpay-login-text">
                                                Quý Khách thực hiện thanh toán
                                                bằng cách: Chuyển khoản bằng
                                                Internet Banking, tại máy ATM,
                                                quầy giao dịch ngân hàng đến số
                                                tài khoản công ty Fado tại 2
                                                ngân hàng.
                                            </div>
                                        </div>
                                        <div className="bank">
                                            ...
                                            <div className="phan-thong-tin-con-lai">
                                                <p>
                                                    Vui lòng chọn chuyển khoản
                                                    nhanh 24/7 để T&T có thể
                                                    nhận được thông tin thanh
                                                    toán một cách nhanh nhất.
                                                    Khi thanh toán tại máy ATM,
                                                    vì không thể ghi chú nội
                                                    dung nên qúy khách vui lòng
                                                    liên hệ qua email hoặc tổng
                                                    đài T&T để được hỗ trợ.
                                                </p>
                                                <p>
                                                    Nhấn nút <b>ĐẶT MUA</b> để
                                                    hoàn tất đơn đặt hàng và
                                                    nhận thông tin tài khoản và
                                                    cú pháp chuyển khoản
                                                </p>
                                                <p>
                                                    Đơn hàng của Quý Khách chỉ
                                                    được người bán thực hiện khi
                                                    T&T xác nhận đơn hàng được
                                                    thanh toán với đầy đủ thông
                                                    tin từ ngân hàng theo cú
                                                    pháp đã được hướng dẫn.
                                                </p>
                                                <p>
                                                    <b>Lưu ý</b> : Một số Ngân
                                                    hàng không hỗ trợ kiểm tra
                                                    sau 19h00:{" "}
                                                    <b>
                                                        {" "}
                                                        Agribank, Đông Á,
            ...
            <footer className="orderpay-footer container">
                <div className="orderpay-footer-web">
                    <b>T&T.vn</b> - T&T.vn - Sàn thương mại điện tử xuyên biên
                    giới hàng đầu Việt Nam <br /> Giấy phép số 0316534223. Chịu
                    trách nhiệm: T&T Global
                </div>
                <div>
                    {" "}
                    <li>
