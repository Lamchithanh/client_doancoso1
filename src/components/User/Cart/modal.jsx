...
function Example() {
    const capnhat = () => toast("Cập nhật thông tin thành công");
            ...
            <Modal show={show} onHide={handleClose}>
                    ...
                    <form action="" className="form-updata-info">
                        <div className="modal-ten-sdt">
                            ...
                            <p style={{ fontSize: "13px", margin: "5px 0" }}>
                                T&T sẽ cần liên hệ theo số điện thoại này để xác
                                nhận hoặc thông báo hẹn thời gian giao hàng /
                                thu tiền trước.
                            </p>
                        </div>
                        <div className="modal-sdt">
                            ...
                            <input type="text" />
                            <p>
                                <span>Dùng để tạo tài khoản và đặt hàng:</span>{" "}
                                T&T sẽ tự động khởi tạo và gửi mail thông tin
                                đăng nhập tài khoản cho Quý Khách. Mọi thông
                                tin, trạng thái của đơn hàng cũng sẽ được thông
                        ...
                        <div className="modal-dia-chi-chinh-xac">
                            <p>
                                {" "}
                                <span>Địa chỉ chính xác</span> (nhập chính xác
                                và chi tiết địa chỉ để đảm bảo nhận hàng đúng
                                thời gian)
                            </p>
                            <textarea
                                type="text"
                ...
                <Modal.Footer>
                    ...
                    <Button
                        ...
                        className="btn-lg"
                    >
                        <span onClick={capnhat}>Cập nhật</span>
                        <ToastContainer />
                    </Button>
