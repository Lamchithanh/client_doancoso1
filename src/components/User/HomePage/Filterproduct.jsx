      ...
      <section className="info-depict">
        <div>
          <p>
            ...
            được tìm thấy tại <span className="title-product-made-in select-county">Mỹ</span>{" "}
          ...
          <p>
            ...
            được tìm thấy từ <span className="title-product-made-in select-county">Mỹ</span>{" "}
